...
```{r pressure}
model <- lm(lnGDPPC ~ lnGDPPCm5 + IVGinim5 + IVGini2m5 + factor(Country) + factor(Year), data = dat)
...
model2 <- lm(lnGDPPC ~ lnGDPPCm5 + IVlnGGm5 + IVlnGG2m5  + IVGinim5 + IVGini2m5  + OPS + TWWIavg + n +  factor(Country) + factor(Year), data = dat) #+ IVlnGG3m5 + IVGini3m5

model4 <- lm(lnGDPPC ~ lnGDPPCm5 + IVlnGGm5 + IVlnGG2m5  + IVGinim5 + IVGini2m5  + OPS + TWWIavg + dpTWWIavg + n +  factor(Country) + factor(Year), data = dat) #+ IVlnGG3m5 + IVGini3m5
